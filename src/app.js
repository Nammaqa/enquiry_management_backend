...
app.use(cors({
  origin: ['http://localhost:5173', 'http://localhost:5174', 'https://enquiry-node.vercel.app', 'https://nammaqa-enquiry.vercel.app', 'https://nammaqa-server.vercel.app',"https://devnammaenquiry.nammasoftware.com"],
